...
latest_obesity_data.to_csv("../assets/obesity_data.csv",index=False)
...
cycling_data_trimmed.to_csv("../assets/cycling_data.csv",index=False)
...
latest_overweight_data.to_csv("../assets/overweight_data.csv",index=False)
